...
@Component({
  selector: 'alt-inline-charts',
  templateUrl: './inline-charts.component.html',
  styleUrls: ['./inline-charts.component.scss']
})
export class InlineChartsComponent implements OnInit, AfterViewInit {
    ...
    $('.knob').knob({
      ...
      draw: function () {
        ...
        if (this.$.data('skin') === 'tron') {
          ...
          let sat = this.startAngle;         // Start angle
          let ea;                           // Previous end angle
          let eat = sat + a;                 // End angle
          const r = true;
...
function drawDocSparklines() {
  ...
  $('.clickdemo').bind('sparklineClick', function (ev) {
    ...
    const sparkline = event.sparklines[0],
